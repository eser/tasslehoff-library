// -----------------------------------------------------------------------
// <copyright file="MimeHelpers.cs" company="-">
...
namespace Tasslehoff.Library.Helpers
{
    ...
    public static class MimeHelpers
    {
        ...
        {
            if (mimeType.StartsWith("text/", StringComparison.InvariantCulture))
            {
                return "quoted-printable";
            }

            if (mimeType.StartsWith("message/", StringComparison.InvariantCulture))
            {
                return "7bit";
            }
